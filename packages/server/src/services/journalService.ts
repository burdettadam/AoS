...
export class JournalService {
   ...
   */
  static getAvailableMovesForPlayer(
    gameState: GameState,
    seat: Seat,
    character?: Character,
  ): AvailableMove[] {
   ...
   */
  private static getUniversalMoves(
    gameState: GameState,
    seat: Seat,
  ): AvailableMove[] {
    const moves: AvailableMove[] = [];
  ...
  static updatePlayerJournal(
    ...
    seat.journal.moves = this.getAvailableMovesForPlayer(
      gameState,
      seat,
      character,
    );
   ...
   */
  static getPlayerJournalsForStoryteller(
    gameState: GameState,
  ): Record<string, { playerName?: string; journal: any }> {
