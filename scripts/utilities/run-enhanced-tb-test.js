...
try {
  ...
  console.log(
    "- packages/shared/src/action-handlers.ts (Handler implementations)",
  );
  console.log(
    "- packages/server/src/services/journal.service.ts (Journal management)",
  );
  console.log(
    "- packages/server/__tests__/tb-gameplay.test.ts (Journal validation tests)",
  );
...
console.log(
  "Use the examples and documentation to update characters to the new system.",
);
