...
const scriptConfigs = [
  {
    ...
    description:
      "The original Blood on the Clocktower script, perfect for beginners.",
    complexity: "beginner",
  ...
  },
  {
    ...
    description:
      "Death is only the beginning. A complex script where dead players remain highly influential.",
    complexity: "advanced",
    ...
    if (!allCharacters.has(char.id)) {
      const normalizedChar = {
        ...
        first_night_reminder:
          char.first_night_reminder || char.firstNightAction || "",
        other_night_reminder:
          char.other_night_reminder || char.otherNightsAction || "",
